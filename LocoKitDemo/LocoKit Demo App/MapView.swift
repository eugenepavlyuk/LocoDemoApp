...
class MapView: MKMapView {
    ...
    func update(with activities: [Activity]) {
//        let loco = LocomotionManager.highlander
        ...
        for activity in activities {
            if activity.activity.automotive || activity.activity.walking || activity.activity.running || activity.activity.cycling {
                addAnnotation(ActivityAnnotation(coordinate: activity.location.coordinate, activity: activity))
            }
        }
    }
